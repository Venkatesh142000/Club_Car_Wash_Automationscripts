    ...
    post {
        always {
            ...
            script {
                ...
                def hasBrokenOnly = brokenInt > 0 && failedInt == 0 && passedInt == 0
                def isAllPassed   = totalInt > 0 && passedInt == totalInt - skippedInt && failedInt == 0 && brokenInt == 0
                def displayResult     = isPartiallyPassed                    ? 'PARTIALLY PASSED'
                                      : hasBrokenOnly                        ? 'BROKEN'
                                      : isAllPassed                          ? 'SUCCESS'
                ...
                def statusIcon    = isPartiallyPassed                    ? '⚠️'
                                  ...
                                  : '⚠️'
                def teamsStatusStyle = isPartiallyPassed                    ? 'warning'
                                      : hasBrokenOnly                        ? 'warning'
                                      : isAllPassed                          ? 'good'
                                      : (currentBuild.result == 'SUCCESS')     ? 'good'
                                      : (currentBuild.result == 'FAILURE')     ? 'attention'
                                      : 'warning'
                def bannerBgColor = isPartiallyPassed                    ? '#d4a017'
                                   : hasBrokenOnly                        ? '#d4a017'
                                   : isAllPassed                          ? '#1f9d55'
